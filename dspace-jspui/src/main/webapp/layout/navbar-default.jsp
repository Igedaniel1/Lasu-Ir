...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="25" src="<%= request.getContextPath() %>/image/lasu-logo.png" alt="DSpace logo" /></a>
       </div>
 ...
 %>
	...
	<% } %>             
             <ul class="dropdown-menu">
               <li><a href="<%= request.getContextPath() %>/mydspace">My LASU Repository</a></li>
	...
	<form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
	    <div class="form-group">
          <input type="text" class="form-control" placeholder="Search LASU IR" name="query" id="tequery" size="25"/>
        </div>
