...
<dspace:layout titlekey="jsp.login.not-in-records.title">
    ...
    <%-- <p>You have a valid Web certficate, but the LASU IR system does not have a
    record of you.  You will need to <a href="<%= request.getContextPath() %>/register">
    register with LASU IR</a> before using those areas of the system that
    ...
    <%-- <p><a href="<%= request.getContextPath() %>/register">Register wth LASU IR</a></p> --%>
