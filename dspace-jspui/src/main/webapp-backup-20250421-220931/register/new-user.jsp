...
<%  } %>
    ...
    <%-- <p>If you've never logged on to LASU IR before, please enter your e-mail
    ...
    <%-- <p>If you or your department are interested in registering with LASU IR, please
    contact the LASU IR site administrators.</p> --%>
    <br/>
