...
<% if (position.contains("top"))
   { %>
    Add or edit text in the box below to have it appear in the top box of the LASU IR home page.
<% }
   else
   { %>
    Add or edit text in the box below to have it appear in the sidebar of the LASU IR home page.
<% } %>
    </p>
