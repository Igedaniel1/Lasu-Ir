...
<!-- Home Banner (only on homepage) -->
<div class="container-fluid py-3" style="background-color: #e6f2ff; color: #003366; margin-top: 0 !important;">
    <div class="row align-items-center text-center">
        <div class="col-md-12">
            <img src="/lasu/image/ige-logo.png" alt="LASU Logo" style="height: 80px;" />
            <h1 style="margin-top: 10px; font-weight: 600; font-family: 'Segoe UI', sans-serif;">Lagos State University Repository</h1>
            <p style="font-size: 16px;">Empowering Research and Learning through Open Access</p>
        </div>
    </div>
</div>
	<div class="jumbotron">
