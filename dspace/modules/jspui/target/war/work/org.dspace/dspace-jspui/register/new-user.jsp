...
<%  } %>
    ...
    <p class="alert">If you've never logged on to LASU IR before, please enter your e-mail address in the box below and click "Register".</p>
    ...
    <br/>
    <div class="alert alert-info">If you or your department are interested in registering with LASU IR, please contact the LASU IR site administrators.</div>
