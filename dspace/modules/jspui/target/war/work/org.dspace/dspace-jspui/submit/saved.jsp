...
<dspace:layout style="submission" locbar="off" navbar="off" titlekey="jsp.submit.saved.title">
	...
	<p class="alert alert-info">Your submission has been saved for you to finish later.  You can continue
        the submission by going to your "My LASU IR" page and clicking on the
        relevant "Resume" button.</p>

    <%-- <p><a href="<%= request.getContextPath() %>/mydspace">Go to My DSpace</a></p> --%>
	<p><a href="<%= request.getContextPath() %>/mydspace">Go to My LASU IR</a></p>
