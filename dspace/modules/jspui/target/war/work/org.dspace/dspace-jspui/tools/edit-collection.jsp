...
<%  } %>
   ...
   <% if(false) { %>
    <% if(bAdminCollection) { %>
    <!-- ===========================================================
         Harvesting Settings - Disabled
         =========================================================== -->
    <div class="panel panel-default">
        <div class="panel-heading">
            <fmt:message key="jsp.tools.edit-collection.form.label15"/>
        </div>
        <div class="panel-body">
    
            <!-- OAI Source -->
            <div class="input-group">
                <label class="input-group-addon" for="source_normal">
                    <fmt:message key="jsp.tools.edit-collection.form.label16"/>
                </label>
            ...
            <!-- OAI Provider -->
            <div class="row">
                <label class="col-md-3" for="oai_provider">
                    <fmt:message key="jsp.tools.edit-collection.form.label19"/>
                </label>
                <span class="col-md-9">
            ...
            <!-- OAI Set ID -->
            <div class="row">
                <label class="col-md-3" for="oai_setid">
                    <fmt:message key="jsp.tools.edit-collection.form.label20"/>
                </label>
                <span class="col-md-9">
            ...
            <!-- Metadata Format -->
            <div class="row">
                <label class="col-md-3" for="metadata_format">
                    <fmt:message key="jsp.tools.edit-collection.form.label21"/>
                </label>
                <span class="col-md-9">
            ...
            <!-- Harvest Level -->
            <div class="input-group">
                <label class="input-group-addon" for="harvest_level">
                    <fmt:message key="jsp.tools.edit-collection.form.label22"/>
                </label>
                <div class="form-control">
            ...
            <!-- Last Harvest Message -->
            <div class="row">
                <label class="col-md-6">
                    <fmt:message key="jsp.tools.edit-collection.form.label26"/>
                </label>
...
<%
    ...
    {
%>
                        <!-- SAFEGUARD: Prevent servlet from crashing by providing dummy values -->
                        <input type="hidden" name="source" value="source_normal" />
                        <input type="hidden" name="oai_provider" value="" />
                        <input type="hidden" name="oai_setid" value="" />
                        <input type="hidden" name="metadata_format" value="" />
                        <input type="hidden" name="harvest_level" value="0" />
