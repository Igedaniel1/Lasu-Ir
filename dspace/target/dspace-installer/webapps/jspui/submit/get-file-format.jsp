...
%>
		...
		<p class="alert alert-info">DSpace could not identify the format of this file.</p>
<%
    }
    else
    {
%>
		...
		<p class="alert alert-info">
            LASU IR recognized the file format as <%= guess.getShortDescription() %>.
            <strong>Please be sure before you change this!</strong>
        </p>
